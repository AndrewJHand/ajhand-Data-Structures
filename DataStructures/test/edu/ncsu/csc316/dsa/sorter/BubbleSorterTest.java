...
public class BubbleSorterTest {
	 ...
	 */
	private BubbleSorter<Student> studentSorterID;
	/**
	 * Private Bubble Sorter to create in setUp by GPA
	 */
	private BubbleSorter<Student> studentSorterGPA;
	...
	public void setUp() {
		...
		studentSorterID = new BubbleSorter<Student>(iDCompare);
		studentSorterGPA = new BubbleSorter<Student>(gPACompare);
	...
	public void testSortStudent() {
		...
		BubbleSorter<Student> naturalSorter = new BubbleSorter<Student>();
