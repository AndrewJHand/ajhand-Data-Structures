...
public class UpTreeDisjointSetForest<E> implements DisjointSetForest<E> {
     ...
     * @author Dr. King
     *
     * @param <E> is the element of the node
     */
    private static class UpTreeNode<E> implements Position<E> {
         ...
         * UpTreeNode
         * 
         * @param count is the count of the node
         */
    ...
    public void union(Position<E> s, Position<E> t) {
        ...
        if(a.getCount() > b.getCount()) {
        	...
        	b.setParent(a);
        	//map.put(a.getElement(), a);
        }
        else {
        	b.setCount(a.getCount() + b.getCount());
        	a.setParent(b);
        	//map.put(b.getElement(), b);
        }
    }

    /**
     * checks if a position is an up tree node
     * @param p is the position
     * @return an up tree node p, or throw exception
     */
