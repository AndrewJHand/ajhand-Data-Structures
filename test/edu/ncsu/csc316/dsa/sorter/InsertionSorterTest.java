...
public class InsertionSorterTest {
	 ...
	 * Private Insertion sorter
	 */
	private InsertionSorter<Student> studentSorterID;
	/**
	 * Private Insertion sorter
	 */
	private InsertionSorter<Student> studentSorterGPA;
	...
	public void setUp() {
		...
		studentSorterID = new InsertionSorter<Student>(iDCompare);
		studentSorterGPA = new InsertionSorter<Student>(gPACompare);
