...
public class MergeSorterTest {
	 ...
	 */
	private MergeSorter<Student> studentSorterID;
	/**
	 * Private Bubble Sorter to create in setUp by GPA
	 */
	private MergeSorter<Student> studentSorterGPA;
	...
	public void setUp() {
		...
		studentSorterID = new MergeSorter<Student>(iDCompare);
		studentSorterGPA = new MergeSorter<Student>(gPACompare);
